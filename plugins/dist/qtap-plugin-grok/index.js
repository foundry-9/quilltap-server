...
var require_react_jsx_runtime_development = __commonJS({
  "node_modules/react/cjs/react-jsx-runtime.development.js"(exports2) {
    ...
    "production" !== process.env.NODE_ENV && (function() {
      ...
      exports2.Fragment = REACT_FRAGMENT_TYPE;
      exports2.jsx = function(type, config2, maybeKey) {
      ...
      exports2.jsxs = function(type, config2, maybeKey) {
        var trackActualOwner = 1e4 > ReactSharedInternals.recentlyCreatedOwnerStacks++;
        return jsxDEVImpl(
          type,
          config2,
...
var plugin = {
  ...
  validateApiKey: async (apiKey, baseUrl) => {
    ...
    try {
      ...
      logger.debug("Grok API key validation result", { context: "plugin.validateApiKey", isValid: isValid2 });
      return isValid2;
    } catch (error) {
