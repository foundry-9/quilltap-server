...
The search bar is your powerful tool for finding anything across Quilltap quickly. Located at the top center of the page, it helps you discover chats, characters, tags, and memories in seconds.
...
The search bar searches across four main categories:

1. **Chats** — Find conversations by title or content
2. **Characters** — Locate characters by name or description
3. **Tags** — Search for content tagged with specific keywords
4. **Memories** — Find stored memories and notes from conversations
...
- **Result categories** — Items grouped by type (chats, characters, tags, memories)
