...
function validateCurlInput(input) {
  ...
  if (obj.render !== void 0 && typeof obj.render !== "boolean") {
    return false;
  }
  return true;
}
...
var Parser = class {
  ...
  ontext(start, endIndex) {
    ...
    (_b = (_a6 = this.cbs).ontext) === null || _b === void 0 ? void 0 : _b.call(_a6, data);
  ...
  ontextentity(cp) {
    ...
    (_b = (_a6 = this.cbs).ontext) === null || _b === void 0 ? void 0 : _b.call(_a6, fromCodePoint(cp));
  ...
  onclosetag(start, endIndex) {
    ...
    if (!this.isVoidElement(name2)) {
      ...
      (_b = (_a6 = this.cbs).onopentagname) === null || _b === void 0 ? void 0 : _b.call(_a6, "br");
  ...
  closeCurrentTag(isOpenImplied) {
    ...
    if (this.stack[this.stack.length - 1] === name2) {
      (_b = (_a6 = this.cbs).onclosetag) === null || _b === void 0 ? void 0 : _b.call(_a6, name2, !isOpenImplied);
      this.stack.pop();
    }
  }
  /** @internal */
...
var validatePositiveInteger = (name2, n2) => {
...
function isSensitiveQueryParameter(name2) {
  const normalized = name2.toLowerCase().replace(/[-_]/gu, "");
...
function isSensitiveHeader(name2) {
  return sensitiveHeaderNames.has(name2.toLowerCase().replace(/_/gu, "-")) || isSensitiveQueryParameter(name2);
}
function redactURL(value) {
  ...
  url.password = "";
  url.hash = "";
  for (const name2 of url.searchParams.keys()) {
    if (isSensitiveQueryParameter(name2)) {
      url.searchParams.set(name2, "***");
    }
  }
  return url.href;
}
var formatRequestDetails = (details) => {
  if (details.options) {
    ...
    if (details.options.query) {
      details.options.query = Object.fromEntries(Object.entries(details.options.query).map(([name2, value]) => [
        name2,
        isSensitiveQueryParameter(name2) ? "***" : value
      ]));
    }
  }
  if (details.url) {
  ...
  if (details.headers) {
    details.headers = Object.fromEntries((details.headers instanceof Headers ? [...details.headers] : Object.entries(details.headers)).map(([name2, value]) => [name2, isSensitiveHeader(name2) ? "***" : value]));
  }
...
var Stream = class _Stream {
  ...
  static fromSSEResponse(response, controller, client, synthesizeEventData) {
    ...
    async function* iterator() {
      ...
      try {
        ...
        if (receivedCompletionSentinel || isTransportAbortError(e2) || controller.signal.aborted && e2 === controller.signal.reason) {
          return;
        }
        throw e2;
      } finally {
  ...
  tee() {
    ...
    const left2 = createStreamTeeQueue();
    const right2 = createStreamTeeQueue();
    ...
    const teeIterator = (queue) => ({
      next: () => {
        ...
        if (queue.length === 0) {
          ...
          left2.enqueue(result);
          right2.enqueue(result);
        }
      ...
      return: async () => {
        if (!queue.canceled) {
          queue.cancel();
          if (left2.canceled && right2.canceled) {
    ...
    return [branch(left2), branch(right2)];
  }
  /**
...
var SSEDecoder = class {
  ...
  decode(line) {
    ...
    const [fieldname, , initialValue] = partition2(line, ":");
...
function assertX509APIOrigin(value) {
  ...
  for (const name2 of target.searchParams.keys()) {
    if (isSensitiveQueryParameter(name2)) {
...
var headerValue = (headers, name2) => Headers.prototype.get.call(headers, name2);
...
function assertSafeHeaders(headers) {
  for (const name2 of Headers.prototype.keys.call(headers)) {
    const canonical = name2.toLowerCase().split("_").join("-");
...
function assertX509FetchOptions(options) {
  ...
  for (const name2 of FORBIDDEN_TRANSPORT_OPTIONS) {
...
function assertX509RequestOptions(options) {
  ...
  if (options && ["body", "headers", "method", "signal"].some((name2) => hasOwn(options, name2))) {
...
var X509WorkloadIdentityAuth = class {
  ...
  retireRequestBody() {
    ...
    if (body) {
      void __classPrivateFieldGet(_a2, _a2, "m", _X509WorkloadIdentityAuth_cancelRequestBody).call(_a2, body);
    }
  }
  ...
  async getToken(options, context) {
    ...
    if (cached && performance.now() < cached.refreshAt && Date.now() < cached.wallRefreshAt) {
      return __classPrivateFieldGet(_a2, _a2, "m", _X509WorkloadIdentityAuth_assignToken).call(_a2, scope, cached);
    }
    ...
    try {
      ...
      return __classPrivateFieldGet(_a2, _a2, "m", _X509WorkloadIdentityAuth_assignToken).call(_a2, scope, refreshed);
    } catch (error) {
  ...
  bindRequest(options, request, adminAPIKey) {
    ...
    const scope = __classPrivateFieldGet(this, _X509WorkloadIdentityAuth_instances, "m", _X509WorkloadIdentityAuth_scope).call(this);
    const { token: token2 } = scope;
    const security = options.__security ?? { bearerAuth: true };
    let approvedAuthorization = token2 ? `Bearer ${token2}` : null;
    if (!token2 && security.adminAPIKeyAuth && adminAPIKey !== null && headerValue(request.headers, "Authorization") !== null) {
...
_a2 = X509WorkloadIdentityAuth, _X509WorkloadIdentityAuth_identityProviderId = /* @__PURE__ */ new WeakMap(), _X509WorkloadIdentityAuth_serviceAccountId = /* @__PURE__ */ new WeakMap(), _X509WorkloadIdentityAuth_configuredRefreshBufferMs = /* @__PURE__ */ new WeakMap(), _X509WorkloadIdentityAuth_configuredRefreshBufferSeconds = /* @__PURE__ */ new WeakMap(), _X509WorkloadIdentityAuth_organization = /* @__PURE__ */ new WeakMap(), _X509WorkloadIdentityAuth_project = /* @__PURE__ */ new WeakMap(), _X509WorkloadIdentityAuth_transport = /* @__PURE__ */ new WeakMap(), _X509WorkloadIdentityAuth_refreshBufferMs = /* @__PURE__ */ new WeakMap(), _X509WorkloadIdentityAuth_cachedToken = /* @__PURE__ */ new WeakMap(), _X509WorkloadIdentityAuth_refresh = /* @__PURE__ */ new WeakMap(), _X509WorkloadIdentityAuth_tokenGeneration = /* @__PURE__ */ new WeakMap(), _X509WorkloadIdentityAuth_instances = /* @__PURE__ */ new WeakSet(), _X509WorkloadIdentityAuth_cancelRequestBody = async function _X509WorkloadIdentityAuth_cancelRequestBody2(body) {
  ...
  if (!cached || cached !== __classPrivateFieldGet(this, _X509WorkloadIdentityAuth_cachedToken, "f") || performance.now() >= cached.expiresAt || Date.now() >= cached.wallExpiresAt || !_a2.isRetryableFailure(error)) {
    return void 0;
  }
  const headers = _a2.retryHeaders(error);
  ...
  try {
    const token2 = await __classPrivateFieldGet(this, _X509WorkloadIdentityAuth_transport, "f").exchange(__classPrivateFieldGet(this, _X509WorkloadIdentityAuth_identityProviderId, "f"), __classPrivateFieldGet(this, _X509WorkloadIdentityAuth_serviceAccountId, "f"), controller.signal);
    const lifetime = token2.expiresIn * 1e3;
  ...
  for (const name2 of supplied.values.keys()) {
    const canonical = name2.toLowerCase().split("_").join("-");
    if ((canonical === "openai-organization" || canonical === "openai-project") && (name2 !== canonical || headerValue(supplied.values, name2) !== (canonical === "openai-organization" ? context.organization : context.project))) {
      throw new OpenAIError("X.509 workload identity cannot override its enrolled organization or project.");
    }
  ...
  for (const name2 of Headers.prototype.keys.call(headers)) {
    const canonical = name2.toLowerCase().split("_").join("-");
    if ((canonical === "openai-organization" || canonical === "openai-project") && name2 !== canonical) {
      throw new OpenAIError("X.509 workload identity cannot override its enrolled organization or project.");
    }
  }
};
...
function normalizeX509CredentialOptions(options) {
  ...
  const conflicting = ["apiKey", "adminAPIKey", "workloadIdentity", "x509Transport"].filter((name2) => {
    const value = options[name2];
    return value !== null && value !== void 0;
  });
  if (conflicting.length > 0) {
    throw new OpenAIError(`The \`credential\` option cannot be combined with ${conflicting.map((name2) => `\`${name2}\``).join(", ")}.`);
  }
  return {
    credential,
    options: {
...
function getName(value, options) {
  ...
  const name2 = "name" in value ? value.name : void 0;
  const explicitName = name2 && String(name2) || "filename" in value && value.filename && String(value.filename);
  if (explicitName) {
...
function getStreamingFileName(value, options) {
  if (isStreamingFile(value)) {
    ...
    return options.stripFilenames === false ? normalizeFilenamePath(name2) : basename(name2) ?? "unknown_file";
  }
...
var addFormValue = async (form, key, value, options) => {
  ...
  if (typeof value === "string" || typeof value === "number" || typeof value === "boolean") {
    ...
    await Promise.all(Object.entries(value).map(([name2, prop]) => addFormValue(form, `${key}[${name2}]`, prop, options)));
  } else {
    throw new TypeError(`Invalid value given to form, expected a string, number, boolean, object, Array, File or Blob but got ${value} instead`);
  }
};
...
var canReuseNativeFile = (value, name2, options) => (name2 == null || name2 === value.name) && !hasFilePropertyOverrides(value, options);
async function toFile(value, name2, options) {
  ...
  if (isFileLike(value)) {
    ...
    if (value instanceof File) {
      if (canReuseNativeFile(value, name2, options)) {
        return value;
      }
      return makeFile([value], name2 ?? value.name, fileOptions);
    }
    return makeFile([await value.arrayBuffer()], name2 ?? value.name, fileOptions);
  }
  if (isResponseLike(value)) {
    const blob = await value.blob();
    name2 ?? (name2 = getName(value));
    const responseOptions = options?.type === void 0 && blob.type ? { ...options, type: blob.type } : options;
    return makeFile(await getBytes(blob), name2, responseOptions);
  }
  ...
  const choices = completion.choices.map((choice2) => {
    ...
    return {
      ...
      message: {
        ...
        parsed: choice2.message.content !== null && choice2.message.content !== void 0 && !choice2.message.refusal && (choice2.message.content !== "" || !choice2.message.tool_calls?.length && !choice2.message.function_call) ? parseResponseFormat(params, choice2.message.content) : null
      }
    };
  });
...
for (const name2 of [
  ...
  const descriptor = Object.getOwnPropertyDescriptor(globalThis, name2);
...
function visitHiddenEventValues(current, kind, visit) {
  ...
  if (kind === "headers") {
    ...
    for (const [name2, value] of headersEntries.call(current)) {
      if (!visit(name2, 8) || !visit(value, 8)) {
        return false;
      }
    }
  }
...
var EventStream = class {
  ...
  on(event, listener) {
    var _a6;
    const listeners = (_a6 = __classPrivateFieldGet(this, _EventStream_listeners, "f"))[event] || (_a6[event] = []);
  ...
  off(event, listener) {
    ...
    const index = listeners.findIndex((l2) => !l2.removed && l2.listener === listener);
    if (index !== -1) {
...
function normalizeToolCallIds(chatCompletion) {
  for (const choice2 of chatCompletion.choices) {
...
var AbstractChatCompletionRunner = class extends EventStream {
  ...
  async _createChatCompletion(client, params, options) {
    ...
    __classPrivateFieldGet(_a3, _a3, "m", _AbstractChatCompletionRunner_validateParams).call(_a3, params);
  ...
  async _runTools(client, params, runner, options) {
    ...
    const runToolCall = async (toolCall) => {
      ...
      const { name: name2, arguments: args } = toolCall.function;
      ...
      if (singleFunctionToCall && singleFunctionToCall !== name2) {
      ...
      const content = __classPrivateFieldGet(_a3, _a3, "m", _AbstractChatCompletionRunner_stringifyFunctionCallResult).call(_a3, rawContent);
...
function captureStructuredMessageSnapshot(choice2) {
  const descriptor = Object.getOwnPropertyDescriptor(choice2, "message");
...
function mapCapturedSnapshotArray(array, maximum, kind, map2) {
...
function ownFunctionToolIdentity(toolCall) {
  ...
  const name2 = Object.getOwnPropertyDescriptor(fn.value, "name");
  if (!name2 || !("value" in name2) || typeof name2.value !== "string" || name2.value.length === 0) {
    return void 0;
  }
  return { type: "function", name: name2.value };
}
...
var ChatCompletionStream = class _ChatCompletionStream extends AbstractChatCompletionRunner {
  ...
  [(_ChatCompletionStream_params = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_audioDoneChoiceIndexes = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_choiceEventStates = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_currentChatCompletionSnapshot = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_hasAutoParseableTool = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_partialJSONParseBudget = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_instances = /* @__PURE__ */ new WeakSet(), _ChatCompletionStream_beginRequest = function _ChatCompletionStream_beginRequest2() {
    ...
    let state2 = __classPrivateFieldGet(this, _ChatCompletionStream_choiceEventStates, "f")[choice2.index];
    if (state2) {
      return state2;
    }
    state2 = {
    ...
    __classPrivateFieldGet(this, _ChatCompletionStream_choiceEventStates, "f")[choice2.index] = state2;
    return state2;
    ...
    for (const choice2 of chunk.choices) {
      const capturedChoice = capturedChoiceFrames.get(choice2);
      const choiceSnapshot = completion.choices[capturedChoice?.index ?? choice2.index];
      ...
      if (choice2.logprobs?.content != null && messageSnapshot.role === "assistant") {
        this._emit("logprobs.content.delta", {
          content: choice2.logprobs?.content,
          snapshot: choiceSnapshot.logprobs?.content ?? []
        });
      }
      if (choice2.logprobs?.refusal != null && messageSnapshot.role === "assistant") {
    ...
    for (let choiceIndex = 0; choiceIndex < choices.length; choiceIndex += 1) {
      const choice2 = captureSnapshotArrayItem(choices, choiceIndex);
      if (!choice2) {
        continue;
      }
      const message = captureStructuredMessageSnapshot(choice2);
      ...
      validatedMessages.set(choice2, Object.freeze({
        message,
        content,
        refusal,
      ...
      const state2 = __classPrivateFieldGet(this, _ChatCompletionStream_choiceEventStates, "f")[choice2.index];
      ...
      for (let toolCallIndex = 0; toolCallIndex < (toolCalls?.length ?? 0); toolCallIndex += 1) {
        ...
        if (!identity) {
          ...
          if (fn2 && typeof fn2.value === "object" && fn2.value !== null) {
            const name2 = Object.getOwnPropertyDescriptor(fn2.value, "name");
            if (name2 && !("value" in name2)) {
              throw new OpenAIError("Chat completion stream contains an unsafe structured JSON snapshot");
            }
          }
          continue;
    ...
    for (const chunkChoice of chunk.choices) {
      ...
      if (isParseableResponseFormat(__classPrivateFieldGet(this, _ChatCompletionStream_params, "f")?.response_format) || __classPrivateFieldGet(this, _ChatCompletionStream_hasAutoParseableTool, "f")) {
        captureStructuredJSONSnapshot(captureStructuredMessageSnapshot(choice2), "refusal");
      }
      if (logprobs) {
        if (choice2.logprobs) {
          const { content: content2, refusal: refusal2, ...rest3 } = logprobs;
          assertIsEmpty(rest3);
          assignOwnProperties(choice2.logprobs, rest3);
          if (content2) {
            (_a6 = choice2.logprobs).content ?? (_a6.content = []);
            choice2.logprobs.content.push(...content2);
          }
          if (refusal2) {
            (_b = choice2.logprobs).refusal ?? (_b.refusal = []);
            choice2.logprobs.refusal.push(...refusal2);
          }
        } else {
          choice2.logprobs = { ...logprobs };
          if (logprobs.content) {
            choice2.logprobs.content = [...logprobs.content];
          }
          if (logprobs.refusal) {
            choice2.logprobs.refusal = [...logprobs.refusal];
          }
        }
      }
      if (finish_reason) {
      ...
      assignOwnProperties(choice2, other);
      if (!delta) {
      ...
      assertIsEmpty(rest2);
      assignOwnProperties(choice2.message, rest2);
      ...
      if (audio) {
        const audioSnapshot = (_c = choice2.message).audio ?? (_c.audio = {});
        if (audio.id != null) {
      ...
      if (function_call) {
        if (choice2.message.function_call) {
          ...
          if (function_call.arguments) {
            (_d = choice2.message.function_call).arguments ?? (_d.arguments = "");
      ...
      if (content != null) {
        if (!choice2.message.refusal && isParseableResponseFormat(__classPrivateFieldGet(this, _ChatCompletionStream_params, "f")?.response_format)) {
          const eventState = __classPrivateFieldGet(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_getChoiceEventState).call(this, choice2);
          ...
          choice2.message.content = (captureStructuredJSONSnapshot(choice2.message, "content") || "") + content;
          if (!parseState.has_non_whitespace) {
            choice2.message.parsed = null;
            ...
            choice2.message.parsed = parseStructuredStreamingJSON(validateStructuredJSONSnapshot(choice2.message.content));
      ...
      if (tool_calls) {
        const toolCallSnapshots = (_e = choice2.message).tool_calls ?? (_e.tool_calls = []);
        for (const toolCallDelta of tool_calls) {
          ...
          const eventState = __classPrivateFieldGet(this, _ChatCompletionStream_hasAutoParseableTool, "f") ? __classPrivateFieldGet(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_getChoiceEventState).call(this, choice2) : void 0;
...
function finalizeChatCompletion(snapshot, params, audioDoneChoiceIndexes, validatedMessages) {
  ...
  const completion = {
    ...rest,
    id,
    choices: mapCapturedSnapshotArray(choices, MAX_STREAM_CHOICES, "choice", (choice2) => {
      const validated = validatedMessages.get(choice2);
      if (!validated) {
        throw new OpenAIError("Chat completion stream contains an unsafe structured JSON snapshot");
      }
      const stableChoice = new Proxy(choice2, {
          ...
          message: {
            ...
            tool_calls: mapCapturedSnapshotArray(tool_calls, MAX_STREAM_TOOL_CALLS, "tool-call", (tool_call, i) => {
              ...
              if (stableTool.type === "custom") {
                ...
                const { input = "", name: name3, ...customRest } = custom || {};
                if (name3 == null) {
                ...
                return {
                  ...
                  id: id3 || `call_${uuid4()}`,
                  type: type2,
                  custom: { ...customRest, name: name3, input }
                };
              }
              ...
              return {
                ...
                id: id2 || `call_${uuid4()}`,
                type,
                function: { ...fnRest, name: name2, arguments: args }
              };
            })
          }
        };
...
async function encodedMultipartFormRequestOptions(options, client, encodings, rawBodyField = null) {
  ...
  const encoded = [];
  for (const [name2, encoding] of Object.entries(encodings)) {
    if (!Object.prototype.hasOwnProperty.call(body, name2))
      continue;
    const value = body[name2];
    const data = encoding.json ? JSON.stringify(value) : value;
    if (typeof data !== "string")
      throw new TypeError(`Multipart field ${name2} must encode as a string`);
    encoded.push([name2, makeFile([data], "", { type: encoding.content_type })]);
    delete body[name2];
  }
  ...
  for (const [name2, part] of encoded)
    form.append(name2, part, "");
  return {
    ...options,
    body: form,
...
function getInputToolByName(input_tools, name2, namespace) {
  for (const tool of input_tools) {
    if (namespace == null) {
      if (tool.type === "function" && tool.name === name2) {
        return tool;
      }
    } else if (tool.type === "namespace" && tool.name === namespace) {
      return tool.tools.find((nested) => nested.type === "function" && nested.name === name2);
    }
  }
  return void 0;
}
...
var OpenAI = class {
  ...
  constructor(clientOptions = {}) {
    ...
    if (usesX509Identity) {
      ...
      if (this.fetchWithAuth !== _a4.prototype.fetchWithAuth || this.fetchWithTimeout !== _a4.prototype.fetchWithTimeout) {
  ...
  async bearerAuth(opts) {
    ...
    if (authentication) {
      if (authentication instanceof X509WorkloadIdentityAuth) {
        if (authentication === this._workloadIdentityAuth && (this.fetchWithAuth !== _a4.prototype.fetchWithAuth || this.fetchWithTimeout !== _a4.prototype.fetchWithTimeout)) {
          throw new OpenAIError("X.509 workload identity does not support overridden fetch dispatch hooks.");
        }
      ...
      const token2 = authentication instanceof X509WorkloadIdentityAuth ? await authentication.getToken(opts, {
  ...
  async _callApiKey(capture) {
    ...
    if (typeof token2 !== "string" || !token2) {
      throw new OpenAIError(`Expected 'apiKey' function argument to return a string but it returned ${token2}`);
    }
    this.apiKey = token2;
    capture?.(this.apiKey);
    return true;
  ...
  async makeRequest(optionsInput, retriesRemaining, retryOfRequestLogID) {
    ...
    try {
      ...
      if (x509Authentication) {
        ...
        for (const [name2, value] of authenticationHeaders?.values ?? []) {
          if (!supplied.nulls.has(name2) && !built.req.headers.has(name2)) {
            built.req.headers.set(name2, value);
          }
        }
    ...
    const security = options.__security ?? { bearerAuth: true };
    const controller = x509Authentication || this.fetchWithTimeout === _a4.prototype.fetchWithTimeout ? createRequestController(req.signal ?? (x509Authentication ? callerSignal : void 0), x509Authentication ? callerSignal : void 0) : new AbortController();
    const remainingTimeout = x509Authentication?.remainingTimeout(options, timeout) ?? timeout;
    const fetchWithAuth = x509Authentication ? _a4.prototype.fetchWithAuth : this.fetchWithAuth;
  ...
  async fetchWithAuth(url, init, timeout, controller, schemes = {
    ...
    if (this._workloadIdentityAuth && !__classPrivateFieldGet(this, _OpenAI_x509Fetch, "f") && schemes.bearerAuth) {
      ...
      if (authHeader === `Bearer ${WORKLOAD_IDENTITY_API_KEY_PLACEHOLDER}`) {
        const token2 = await this._workloadIdentityAuth.getToken();
        headers.set("Authorization", `Bearer ${token2}`);
      }
    }
    const fetchWithTimeout = __classPrivateFieldGet(this, _OpenAI_x509Fetch, "f") ? _a4.prototype.fetchWithTimeout : this.fetchWithTimeout;
  ...
  async buildRequest(inputOptions, { retryCount = 0 } = {}) {
    if (__classPrivateFieldGet(this, _OpenAI_x509Authentication, "f") && !__classPrivateFieldGet(this, _OpenAI_x509Authentication, "f").inRequest(this)) {
      ...
      return await authentication.runRequest(async () => {
        const built = await _a4.prototype.buildRequest.call(this, inputOptions, { retryCount });
...
var _a5;
_a5 = brand_privateBedrockClient;
...
function parseHeaders(headerInput) {
  ...
  for (const header of headerList) {
    ...
    if (colonIndex > 0) {
      const name2 = header.substring(0, colonIndex).trim();
...
async function executeCurlRequest(input, config, browserUserAgent) {
