...
export default function AppearanceTab() {
  ...
  // Handle nav theme selector toggle
  const handleNavThemeSelectorChange = async (show: boolean) => {
    clientLogger.info('AppearanceTab: changing nav theme selector visibility', { show })
      ...
      <section>
        ...
        `}>
          ...
          <button
            ...
            disabled={isLoading}
            onClick={() => !isLoading && handleNavThemeSelectorChange(!showNavThemeSelector)}
            className={`
