        ...
        <div className="p-3 bg-purple-50 dark:bg-purple-950/30 border-b border-purple-200 dark:border-purple-800">
          ...
          <div className="space-y-2">
            {entry.toolResults.map((tool, idx) => (
              <details
                key={`tool-${idx}`}
                className="bg-white dark:bg-slate-800 rounded border border-purple-300 dark:border-purple-700 group/tool [&[open]>summary>svg.chevron]:rotate-90"
              >
                <summary className="px-2 py-1.5 cursor-pointer select-none flex items-center gap-2 hover:bg-purple-100 dark:hover:bg-purple-900/30 rounded group">
                  <svg className="chevron w-3 h-3 transition-transform duration-200 text-purple-600 dark:text-purple-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                  </svg>
                ...
                <div className="px-3 py-2 border-t border-purple-200 dark:border-purple-700 bg-purple-50/50 dark:bg-purple-950/20">
                  <div className="font-mono text-xs bg-white dark:bg-slate-800 rounded p-2 border border-purple-200 dark:border-purple-700 max-h-[300px] overflow-y-auto">
