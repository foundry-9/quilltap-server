...
- **Documentation for Everything**
  ...
  - [features/complete/plugin_installation.md](features/complete/plugin_installation.md) — npm-based plugin installation system: search, install/uninstall APIs, manifest validation, and Docker configuration — Grade: A (implemented feature) — Last updated: 2026-01-27
