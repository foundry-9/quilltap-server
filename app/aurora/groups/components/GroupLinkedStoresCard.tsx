...
/**
 * Group Linked Stores Card
 *
 * Expandable card displaying document stores linked to this group.
 * Users can link/unlink stores.
 */
...
interface GroupLinkedStoresCardProps {
...
export function GroupLinkedStoresCard({
  linkedStores,
  allStores,
  expanded,
  onToggle,
