...
5. Clean up old dev GitHub releases for all but the latest tag
   ...
   - Remove the old releases from GitHub if they're there, like this: `gh release delete --yes 4.0.0-dev.1`
6. Delete all the old development release tags (everything that is **NOT** the latest):
