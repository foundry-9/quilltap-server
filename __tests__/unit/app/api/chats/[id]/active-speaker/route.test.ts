/**
 * Tests for deprecated /api/chats/[id]/active-speaker endpoint
 * This route has been deprecated and returns 410 Gone.
 * The functionality has moved to /api/v1/chats/[id]?action=set-active-speaker
 */
...
let POST: typeof import('@/app/api/chats/[id]/active-speaker/route').POST
...
describe('Active Speaker API Route - Deprecated', () => {
  beforeEach(() => {
    jest.clearAllMocks()
  ...
  describe('POST /api/chats/:id/active-speaker', () => {
