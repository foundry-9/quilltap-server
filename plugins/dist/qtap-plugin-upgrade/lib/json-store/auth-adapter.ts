...
export function JsonStoreAdapter(jsonStore: JsonStore): Adapter {
  ...
  async function saveAccounts(accounts: Account[]): Promise<void> {
    try {
      ...
      console.error('Failed to save accounts', { context: 'JsonStoreAdapter.saveAccounts' }, error instanceof Error ? error : undefined);
      throw error;
    }
  }
  ...
  return {
    async createUser(user: Omit<AdapterUser, 'id'>): Promise<AdapterUser> {
      try {
        ...
        console.log('User created', { context: 'JsonStoreAdapter.createUser', userId: created.id });
        ...
        console.error('Failed to create user', { context: 'JsonStoreAdapter.createUser', email: user.email }, error instanceof Error ? error : undefined);
        throw error;
      }
    },
    ...
    async deleteUser(userId: string): Promise<void> {
      ...
      console.warn('User deletion not supported in single-user system', { context: 'JsonStoreAdapter.deleteUser', userId });
    },
    ...
    async linkAccount(account: AdapterAccount): Promise<void> {
      try {
        ...
        console.error('Failed to link account', { context: 'JsonStoreAdapter.linkAccount', provider: account.provider }, error instanceof Error ? error : undefined);
        throw error;
      }
    },
