...
| ---- | ---- | ---- |
| The Foundry | Architecture, plugins, packages, LLMs | Roleplay template plugin capability removed, character plugin data API, `plugin-types` 2.2.0, `plugin-utils` 2.2.0 |
...
| The Lantern | Image generation | Equipped wardrobe items in image prompts, per-conversation avatar generation, manual avatar regeneration, solo portrait fix, image clipboard fixes |
