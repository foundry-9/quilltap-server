    ...
    <div style={{ padding: '1.5rem' }}>
      ...
      <section style={{ marginBottom: '2rem' }}>
        ...
        <div className="qt-tabs">
          ...
          <div className="qt-tabs-content">
            {activeTab === 'tab1' && (
              <div className="qt-tab-panel">
      ...
      <section style={{ marginBottom: '2rem' }}>
        ...
        <div className="qt-tabs qt-tabs-pill">
          <div className="qt-tabs-list">
            <button
      ...
      <section style={{ marginBottom: '2rem' }}>
        ...
        <div className="qt-tabs qt-tabs-vertical" style={{ display: 'flex', gap: '1.5rem' }}>
          <div className="qt-tabs-list" style={{ flexDirection: 'column', borderBottom: 'none', borderRight: '1px solid var(--color-border)', paddingRight: '1rem' }}>
            <button className="qt-tab qt-tab-active" style={{ justifyContent: 'flex-start' }}>General</button>
            <button className="qt-tab" style={{ justifyContent: 'flex-start' }}>Security</button>
            <button className="qt-tab" style={{ justifyContent: 'flex-start' }}>Integrations</button>
            <button className="qt-tab" style={{ justifyContent: 'flex-start' }}>Billing</button>
          </div>
          <div className="qt-tabs-content" style={{ flex: 1 }}>
            <div className="qt-tab-panel">
              <h4 style={{ fontWeight: 600, marginBottom: '0.5rem' }}>General Settings</h4>
              <p style={{ color: 'var(--color-muted-foreground)' }}>
        ...
        <div className="qt-navbar">
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <nav className="qt-nav">
              <a href="#" className="qt-nav-link qt-nav-link-active">Dashboard</a>
              <a href="#" className="qt-nav-link">Characters</a>
              <a href="#" className="qt-nav-link">Chats</a>
              <a href="#" className="qt-nav-link">Settings</a>
            </nav>
          </div>
