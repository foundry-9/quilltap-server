...
- [ ] Complete embedding of files
  - [ ] Text files
  - [ ] Files whose text can be extracted
  - [ ] All images should have database metadata with a description
  - [ ] Any images generated by Lantern should have the original prompt
  - [ ] search_files tool
...
- [ ] AI direct character edit
  - [ ] Give the AI instructions, it proposes edits to the character
