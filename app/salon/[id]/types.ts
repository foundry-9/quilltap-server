...
export interface Message {
  ...
  /** Personified feature that authored this message (e.g., 'lantern' for Lantern announcements, 'aurora' for character-avatar refreshes) */
  systemSender?: 'lantern' | 'aurora' | null
