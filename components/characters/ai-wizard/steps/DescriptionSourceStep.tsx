            ...
            <div>
              ...
              >
                {uploading ? (
                  ...
                  <>
                    <Icon name="image" className="w-8 h-8 qt-text-secondary mb-2" />
          ...
          {uploadedDocumentName ? (
            <div className="space-y-3">
              <div className="flex items-center gap-3 p-3 rounded-lg border qt-border-default bg-background">
                <Icon name="file" className="w-8 h-8 qt-text-secondary flex-shrink-0" />
            ...
            <div>
              ...
              >
                {uploadingDocument ? (
                  ...
                  <>
                    <Icon name="file" className="w-8 h-8 qt-text-secondary mb-2" />
      ...
      {needsVisionProfile && (source === 'upload' || source === 'gallery') && (
        <div className="p-4 rounded-lg border qt-border-warning/50 qt-bg-warning/10 space-y-3">
          <div className="flex items-start gap-2">
            <Icon name="alert-triangle" className="w-5 h-5 qt-text-warning mt-0.5 flex-shrink-0" />
            <div>
