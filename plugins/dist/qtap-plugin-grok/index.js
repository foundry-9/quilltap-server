...
function toGrokImageModerationError(error) {
...
var GrokImageProvider = class {
  ...
  async generateImage(params, apiKey) {
    ...
    try {
      ...
      if (mapped !== error) {
        logger2.info("Grok Images API refused the request on content grounds", {
  ...
  async getAvailableModels(apiKey) {
    ...
    logger2.debug("Discovered Grok image-generation models", {
