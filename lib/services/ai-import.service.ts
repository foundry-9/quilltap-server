      ...
      ? [
          {
            id: crypto.randomUUID(),
            name: 'AI Generated',
            shortPrompt: stepResults.physical_descriptions.shortPrompt,
            mediumPrompt: stepResults.physical_descriptions.mediumPrompt,
            longPrompt: stepResults.physical_descriptions.longPrompt,
            completePrompt: stepResults.physical_descriptions.completePrompt,
