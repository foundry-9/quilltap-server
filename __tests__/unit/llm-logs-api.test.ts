...
const baseLog = {
  ...
  provider: 'openai',
  modelName: 'gpt-4o',
  request: { messageCount: 1, messages: [], temperature: null, maxTokens: null, toolCount: 0, fullMessages: [] },
  response: { contentPreview: 'Hello', contentLength: 5, fullContent: 'Hello', error: null },
  usage: null,
  cacheUsage: null,
  durationMs: 1000,
